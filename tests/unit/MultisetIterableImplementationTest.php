...
class MultisetIterableImplementationTest extends Unit
{
    /**
     ...
     * @dataProvider dataProviderForMultisets
     *
     * @param array $sets
     * @param int $m
    ...
    public function testStrict(array $sets, int $m, array $expected): void
    {
        ...
        // When
        foreach (MultisetIterableImplementation::partialIntersection(true, $m, ...$sets) as $value) {
            $result[] = $value;
        }
        sort($result);
        sort($expected);
    ...
    public function testNonStrict(array $sets, int $m, array $expected): void
    {
        ...
        // When
        foreach (MultisetIterableImplementation::partialIntersection(false, $m, ...$sets) as $value) {
            $result[] = $value;
        }
        sort($result);
        sort($expected);
    ...
    public function dataProviderForMultisets(): array
    {
        return [
            [
                [
